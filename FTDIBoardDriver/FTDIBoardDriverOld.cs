...
namespace BoardDriver
{
    ...
    /// </summary>
    public class FTDIBoardDriverOLD:IBoard
    {
        ...
        public CMulBoard MulBoard = new CMulBoard();
        public CRxBoard RxBoard = new CRxBoard();
        public CRxSubBoard RxSubBoard = new CRxSubBoard();
        public CPaBoard PaBoard = new CPaBoard();
        public CTxBoard TxBoard = new CTxBoard();

        public CDebugBoard DebugP10 = new CDebugBoard();
        public CMulBoard MulBoardP10 = new CMulBoard();
        public CMulBoard_P2 MulBoardP20 = new CMulBoard_P2();
        public CRxBoard RxBoardP10 = new CRxBoard();
        public CRxBoard RxBoardP20 = new CRxBoard();
        public CRxSubBoard RxSubBoardP10 = new CRxSubBoard();
        public CRxSubBoard RxSubBoardP20 = new CRxSubBoard();
        public CPaBoard PaBoardP10 = new CPaBoard();
        public CPaBoard PaBoardP20 = new CPaBoard();
        public CTxBoard TxBoardP10 = new CTxBoard();
        public CTxBoard_P2 TxBoardP20 = new CTxBoard_P2();
        #endregion
        public FTDIBoardDriverOLD()
        {
        ...
        public long Read(string regName,string Group)
        {
            ...
            if (iRegAddr == 0) MessageBox.Show("Not Find this Register:" + regName);
            int ReadWrite = 0;
            int addedClock = ADDED_CLOCK;
            int ReadVe = VE;
            int RegControlBitLength = 9 + SPIContol.Length;
        ...
        {
            int addedClock = ADDED_CLOCK;
            long RegControlBit = GetControlData(0x02, 0, "");
            long data = Read_Data(32, RegControlBit, 9, addedClock, 1);
        ...
        public long ReadFPGAVersion(int BoardID)
        {
            string FPGARegName = null;
            switch(BoardID)
            {
                case 2:
                    //FPGARegName = Mixer.Mixer_FPGA_VERSION.EquipmentName;
                    break;
                case 29:
                    break;
                case 15:
                    FPGARegName = MulBoard.Mul_FPGA_VERSION.EquipmentName;
                    break;
                case 23:
                    FPGARegName = TxBoard.Tx_FPGA_VERSION.EquipmentName;
                    break;
                case 30:
                    FPGARegName = RxBoard.Rx_FPGA_VERSION1.EquipmentName;
                    break;
                case 27:
                    FPGARegName = PaBoard.Pa_FPGA_VERSION1.EquipmentName;
                    break;
                case 0:
                    FPGARegName = Debug.Debug_FPGA_VERSION1.EquipmentName;
                    break;
            }
            long data = Read(FPGARegName);
            data = getBits(data, 4, 3, 32);
            return data;
        }
    #endregion
        ...
        public void startExtAdc()
        {
            ...
            Write(Debug.Debug_ABUS_ADC.EquipmentName, Convert.ToUInt32("D0140003", 16));// 32005000003);
        }
        public long readExtAdc()
        {
            long data = Read(Debug.Debug_ABUS_ADC.EquipmentName);
            return data >> 16;
        }
        //read boards Abus
        public long selectAndReadAbus(UInt32 boardCode)
        {
            //SetBoard(Debug.ID);
            UInt32 dataInt;
            dataInt = (UInt32)Read(Debug.Debug_ABUS_CTRL.EquipmentName);
            Thread.Sleep(20);
            //打开Debug板上对于单板Abus通道
            long data = setBits(dataInt, boardCode, 4, 4, 32);
            Write(Debug.Debug_ABUS_CTRL.EquipmentName, data);
            Thread.Sleep(2);
            return readExtAdc();    
        }
        ...
        #region Flash Function
            ...
            public bool SetHeader(int BoardId, string[] data)
            {
                ...
                switch (BoardId)
                {
                    ...
                    case 29: //SubRx
                        ...
                        this.WriteFlashString_E(BoardId, "1000", data[1]);
                        this.WriteFlashString_E(BoardId, "10000", data[2]);
                        break;
                    case 23:
                    case 30:
                    case 31:
            ...
            public bool SetHeaderByString(int BoardId, string data)
            {
                ...
                return SetHeader(BoardId, HeaderToFW);
            }
            ...
            void flashRegWrite_X(int BoardId, string command, string address, string ASCStringData) //Address: data or address + data
            {
                ...
                int dataBitLength = 8+1 + command.Length * 4 + address.Length * 4 + ASCStringData.Length * 4;//9 = SPI addr(8 bits) + Read/Write(1 bit)
            ...
            string flashRegRead_X(int BoardId, string command, string address,int ReadBitLength) //value, read bit number
            {
                ...
                int dataBitLength = 8 + 1 + command.Length * 4 + address.Length * 4;
                int rem = dataBitLength % 8;
                if (rem != 0)
                {
                    RegControlBit = RegControlBit << (8 - rem);
            ...
            public void ClearFalsh_E(int BoardId, string address)
            {
                ...
                flashRegWrite_E(BoardId, "111", address, "");
            }
            ...
            public string ReadFlashString_E(int BoardId, string address)
            {
                ...
                char charValue;
                string value = "";
                int iAddr = Convert.ToInt16(address);
                while (true)
                {
