...
namespace Keysight.ModularInstruments.Core.Register
{
    public class Register:IRegister
    {
        ...
        public BoardDriver.IVIDriver driver; //driver = new BoardDriver.VXT3BoardDriver();
        public int LastBF
        {
            get
            {
        ...
        public void Apply(bool ForceApply)
        {
            ...
            driver.Write(GroupName, regName, mValue);    
        }
        ...
        public int Read()
        {
            ...
            long dataBack = driver.Read(GroupName, regName);
            //int mask = 0x1FFFE;
            //dataBack = (dataBack & mask) >> 1;            
            mValue = (UInt16)dataBack;
            return mValue;
        }
